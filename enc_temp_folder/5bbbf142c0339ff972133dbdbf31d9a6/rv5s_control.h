    ...
    RV5S_CONTROL(std::string name, SimComponent* parent) : Control(name, parent) {
        ...
        /*comp_flag_ctrl << [=] {
            switch(opcode.uValue()){
                ...
                case RVInstr::BLTFU: return CompFlagOp::LTU;
                case RVInstr::BGTFU: return CompFlagOp::GTU;
                case RVInstr::BLEFU: return CompFlagOp::LTEU;
                case RVInstr::BGEFU: return CompFlagOp::GTEU;
        ...
        do_br_with_flag << [=] {
            switch(opcode.uValue()) {
                ...
                case RVInstr::BLTFU: case RVInstr::BGTFU: case RVInstr::BLEFU: case RVInstr::BGEFU:
                    return 1;
                default: return 0;
            }
        };*/
